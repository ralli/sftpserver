...
import de.ralli.sftpserver.core.util.KeySerializer;
...
public class KeySerializerImpl implements KeySerializer {
    ...
    public String toSecSSHString(PublicKey key) {
        ...
        int test = 0;
        try {
            StringReader reader = new StringReader(Base64.encodeBase64String(encodePublicKey(key)));
            int ch;
    ...
    public PublicKey loadPublicKey(final String _key) throws PublicKeyParseException {
        ...
        if (c == 's') {
            ...
            throw new PublicKeyParseException(PublicKeyErrorCode.UNKNOWN_PUBLIC_KEY_FILE_FORMAT);
        }

        final SSHByteArraySerializer buf = new SSHByteArraySerializer(Base64.decodeBase64(base64.getBytes()));
        ...
        if (SSH2_DSA_KEY.equals(type)) {
            ...
            throw new PublicKeyParseException(PublicKeyErrorCode.UNKNOWN_PUBLIC_KEY_CERTIFICATE_FORMAT);
        }
    ...
    public PublicKey loadPublicKey(InputStream in) {
        try {
            ...
            throw new PublicKeyParseException(PublicKeyErrorCode.UNKNOWN_PUBLIC_KEY_FILE_FORMAT, ex);
        }
    }
     ...
     */
    public String extractOpenSSHBase64(final String _key) throws PublicKeyParseException {
        final String base64;
        try {
            ...
            throw new PublicKeyParseException(PublicKeyErrorCode.CORRUPT_OPENSSH_PUBLIC_KEY_STRING);
        }
     ...
     */
    private String extractSecSHBase64(final String _key) throws PublicKeyParseException {
        ...
        for (final String line : _key.split("\n")) {
            ...
            if (!startKey && trimLine.equals(BEGIN_PUB_KEY)) {
                ...
                if (trimLine.equals(END_PUB_KEY)) {
                    ...
                    if (startKeyBody) {
                        throw new PublicKeyParseException(PublicKeyErrorCode.CORRUPT_SECSSH_PUBLIC_KEY_STRING);
     ...
     *      Section 6.6</a>
     */
    private PublicKey decodeDSAPublicKey(final SSHByteArraySerializer _buffer) throws PublicKeyParseException {
        ...
        try {
            ...
            throw new PublicKeyParseException(PublicKeyErrorCode.SSH2DSA_ERROR_DECODING_PUBLIC_KEY_BLOB, e);
        }
    }
     ...
     *      Section 6.6</a>
     */
    private PublicKey decodeRSAPublicKey(final SSHByteArraySerializer _buffer) throws PublicKeyParseException {
        ...
        try {
            ...
            throw new PublicKeyParseException(PublicKeyErrorCode.SSH2RSA_ERROR_DECODING_PUBLIC_KEY_BLOB, ex);
        }
    }
}
